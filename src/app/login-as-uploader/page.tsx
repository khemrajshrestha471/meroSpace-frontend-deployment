...
import OldCredentialsVerify from "@/components/OldCredentialsVerify"
...
const page = () => {
  ...
  function onSubmit(data: z.infer<typeof FormSchema>) {
    ...
    fetch("https://mero-space-backend-deployment.vercel.app/login-as-uploader", {
      method: "POST",
      headers: {
