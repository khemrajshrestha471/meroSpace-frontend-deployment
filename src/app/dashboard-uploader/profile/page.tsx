...
import { z } from "zod";
import OldPasswordVerify from "@/components/OldPasswordVerify";
...
const Page = () => {
        ...
        const fetchData = async () => {
          ...
          try {
            const response = await fetch(
              `https://mero-space-backend-deployment.vercel.app/get-profile/${isUserIdJwt}`
            );
  ...
  const handleSubmit = form.handleSubmit(async (data) => {
    ...
    try {
      const response = await fetch(
        `https://mero-space-backend-deployment.vercel.app/verify-changed-email/${isUserIdJwt}`,
        {
          method: "POST",
          headers: {
  ...
  const finalDataSubmit = async (
    ...
    try {
      const response = await fetch(
        `https://mero-space-backend-deployment.vercel.app/uploader-profile-modified/${isUserIdJwt}`,
        {
          method: "PATCH",
          credentials: "include",
          headers: {
  ...
  const deleteMyAccount = async () => {
    try {
      const response = await fetch(
        `https://mero-space-backend-deployment.vercel.app/delete-my-account/${isUserIdJwt}`,
        {
          method: "DELETE",
        }
      );
