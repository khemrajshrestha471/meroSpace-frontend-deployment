      ...
      try {
        ...
        if (decodedToken && decodedToken.username && decodedToken.userId) {
          ...
          if (
            ...
            router.push(
              `check1/test2/profile?username=${decodedToken.username}&role=${decodedToken.role}&Id=${decodedToken.userId}`
            );
          }
        }
            ...
            <Form {...form} key={item._id.toString()}>
              <form onSubmit={handleSubmit} className="w-2/3 space-y-6">
                ...
                <div className="flex space-x-4 mb-4">
                  ...
                  <Link
                    href={`check1/test2/profile?username=${isdecodedToken?.username}&role=${isdecodedToken?.role}&Id=${isdecodedToken?.userId}`}
