...
import ChangePasswordSeeker from "@/components/ChangePasswordSeeker";
...
const OldPasswordVerifySeeker = () => {
  ...
  function onSubmit(data: z.infer<typeof FormSchema>) {
    ...
    fetch(`https://mero-space-backend-deployment.vercel.app/verify-seeker-old-password/${isUserIdJwt}`, {
      method: "POST",
      headers: {
...
export default OldPasswordVerifySeeker;
