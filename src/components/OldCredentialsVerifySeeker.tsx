...
import { z } from "zod";
import ForgotPasswordSeeker from "@/components/ForgotPasswordSeeker";
...
const OldCredentialsVerifySeeker = () => {
  ...
  return (
    <div>
      {!showNewPasswordField ? (
        ...
        <ForgotPasswordSeeker userId={userId} />
      )}
    </div>
  );
};

export default OldCredentialsVerifySeeker;