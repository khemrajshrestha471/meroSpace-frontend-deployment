...
const ForgotPasswordSeeker = ({ userId }: { userId: string }) => {
  ...
  function onSubmit(data: z.infer<typeof FormSchema>) {
    fetch(`https://mero-space-backend-deployment.vercel.app/change-seeker-password/${userId}`, {
      method: "PATCH",
      credentials: "include",
      headers: {
...
export default ForgotPasswordSeeker;